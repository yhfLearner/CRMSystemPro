...
(/** @lends <global> */function( $ ) {
	...
	function _fnBuildHead( oSettings )
	{
		...
		for ( i=0, ien=columns.length ; i<ien ; i++ ) {
			...
			_fnRenderer( oSettings, 'templates.pages.header.html' )(
	...
	function _fnDraw( oSettings )
	{
		...
		_fnCallbackFire( oSettings, 'aoHeaderCallback', 'templates.pages.header.html', [ $(oSettings.nTHead).children('tr')[0],
	...
	var _selector_row_indexes = function ( settings, opts )
	{
		...
		else if ( order == 'index.html' || order == 'original' ) {
			for ( i=0, ien=settings.aoData.length ; i<ien ; i++ ) {
				if ( search == 'none' ) {
					a.push( i );
				}
